import { CalendarDays, ClipboardList, Gauge, GraduationCap, LogOut, Bell, UserCircle, Users, BookOpen, Megaphone, ShieldCheck, UserRoundCog, PanelLeftClose, PanelLeftOpen, Clock3, TrendingUp, Settings, Brain, Search, BarChart3 } from 'lucide-react';
...
const base = [
  ...
  ['/calendar','Kalender',CalendarDays], ['/focus','Focus Mode',Brain], ['/insights','Insight',BarChart3], ['/search','Pencarian',Search], ['/notifications','Notifikasi',Bell], ['/profile','Profil',UserCircle], ['/settings','Pengaturan',Settings]
] as const;
const admin = [
