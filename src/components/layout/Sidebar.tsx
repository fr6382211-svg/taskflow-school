  ...
  return (
    ...
    >
        ...
        <div className={cn('flex min-w-0 items-center gap-3', collapsed && 'mx-auto')}>
          ...
          {!collapsed && (
            <div className="min-w-0">
              <div className="truncate text-sm font-semibold tracking-tight" style={{ fontFamily: 'var(--tf-font-display)', color: 'var(--tf-ink)' }}>Fathur School Hub</div>
      ...
      <div className="m-3 p-3" style={{ borderTop: '1px solid var(--tf-rule)' }}>
        ...
        {!collapsed && <>
          <p className="truncate text-xs font-medium" style={{ color: 'var(--tf-ink)' }}>{WORKSPACES[workspaceId].name} • School Hub</p>
