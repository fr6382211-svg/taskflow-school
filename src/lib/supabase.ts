...
// NOTE (security audit): unlike the Google Calendar key, a Supabase
// "publishable"/anon key is DESIGNED to be public — real access control comes
// entirely from Row Level Security policies (verified separately in this
// audit). This hardcoded fallback is kept intentionally so the app still
// builds if env vars are momentarily missing, but you should still prefer
// setting VITE_SUPABASE_URL / VITE_SUPABASE_PUBLISHABLE_KEY in your
// deployment environment and rotate this value if the project ref ever
// changes.
