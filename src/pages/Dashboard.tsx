...
import StudyBuddyPanel from '../components/dashboard/StudyBuddyPanel';
...
export default function Dashboard() {
  ...
  const { streak: focusStreak } = useFocusStreak();
    ...
    <div className="hub-dashboard mx-auto w-full max-w-[1680px] space-y-4 pb-10 fade-up">
      ...
      <section className="grid grid-cols-2 gap-3 xl:grid-cols-4">
        {tasksLoading ? (
          ...
          <>
            <Reveal delay={0} className="hub-kpi hub-card-interactive">
              ...
              <div className="hub-kpi__value"><AnimatedNumber value={stats.pending} /></div>
            ...
            <Reveal delay={60} className="hub-kpi hub-card-interactive">
              ...
              <div className="hub-kpi__value"><AnimatedNumber value={completionRate} suffix="%" /></div>
              <div className="hub-progress"><span style={{ width: `${Math.max(4, completionRate)}%`, background: '#10b981' }} /></div>
            </Reveal>
            <Reveal delay={120} className="hub-kpi hub-card-interactive">
              ...
              <div className="hub-kpi__value"><AnimatedNumber value={agendaSchedule.length} /></div>
              <div className="hub-kpi__meta">{activeDay ?? 'Tidak ada agenda'}</div>
            </Reveal>
            <Reveal delay={180} className="hub-kpi hub-card-interactive">
              ...
              <div className="hub-kpi__value"><AnimatedNumber value={focusStreak.currentStreak} /></div>
              <div className="hub-kpi__meta">hari fokus berturut-turut</div>
            </Reveal>
          </>
        )}
      </section>
      ...
      <SmartAdvisorCard now={now} tasks={tasks} schedule={schedule} streak={focusStreak} variant="compact" />
