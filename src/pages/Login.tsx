        ...
        <div className="mx-auto w-full max-w-[470px] py-5 sm:py-8">
          <div className="mb-7 flex items-center justify-between gap-3 lg:hidden">
            <div className="flex items-center gap-2.5">
              <img src="/brand/fathur-school-hub-crest.png" alt="FAZET" className="h-10 w-10 rounded-xl object-cover" />
              <div><div className="text-sm font-black">FAZET</div><div className="text-[9px] font-bold uppercase tracking-[0.18em] text-slate-400">Academic Velocity Workspace</div></div>
            </div>
  ...
  return (
    <AuthLayout eyebrow="Welcome back">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-black tracking-[-0.03em] text-slate-950 dark:text-white sm:text-4xl">Masuk ke FAZET</h1>
