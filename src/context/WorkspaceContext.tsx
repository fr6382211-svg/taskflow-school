...
export const WORKSPACES: Record<WorkspaceId, WorkspaceDefinition> = {
  fathur: { id:'fathur', name:'Fathur', eyebrow:'School', description:'Workspace akademik pribadi Fathur.', schoolLabel:'SMAN 2 Tuban', birthdayLabel:'Ulang Tahun Fathur', birthdayMonth:3, birthdayDay:12, accent:'indigo', scheduleSource:'supabase' },
  mazet: { id:'mazet', name:'Mazet', eyebrow:'College', description:'Workspace kuliah Mazet dengan jadwal kuliah terpisah.', schoolLabel:'Mazet • College', birthdayLabel:'Ulang Tahun Mazet', birthdayMonth:5, birthdayDay:30, accent:'violet', scheduleSource:'mazet-json' },
};
